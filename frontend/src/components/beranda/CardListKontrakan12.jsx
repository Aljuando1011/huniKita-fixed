...
const CardListKontrakan12 = () => {
  return (
    <>
      <div className="relative w-[376px] h-[340px] hover:shadow-2xl rounded-[20px]">
        ...
        <div className="absolute w-[370px] h-[113px] top-[200px] left-px">
          <div className="absolute w-[370px] h-[113px] top-0 left-0">
            <div className="absolute w-[372px] h-[65px] top-0 left-0">
              <div className="relative h-[65px]">
                ...
                <div className="absolute w-[339px] h-[30px] top-[35px]">
                  <p className="absolute w-[370px] top-0 left-0 [font-family:'Poppins',Helvetica] font-normal text-[#000000cc] text-[10px] text-justify tracking-[0] leading-[normal]">
            ...
            <div className="inline-flex flex-col mt-5 h-[27px] items-center justify-center gap-[10px] p-[10px] absolute top-[86px] left-0 bg-[#4e97d1] rounded-[5px] hover:bg-[#4e86d1] hover:cursor-pointer">
